...
{
    /// <summary>
    /// Pruebas unitarias para <see cref="ShowService"/>.
    /// </summary>
    public class ShowServiceTests : IDisposable
    {
        ...
        /// <summary>
        /// Constructor que configura el contexto de la base de datos en memoria y las configuraciones necesarias.
        /// </summary>
        ...
        /// <summary>
        /// Prueba que FetchAndStoreShowsAsync lanza una HttpRequestException cuando ocurre un error de red.
        /// </summary>
        [Fact]
